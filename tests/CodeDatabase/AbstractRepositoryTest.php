...
class AbstractRepositoryTest extends AbstractTestCase
{
    ...
    public function test_if_should_return_all_without_args()
    {
    ...
    public function test_if_should_return_all_with_args()
    {
        $mockRepository = m::mock(AbstractRepository::class);
        $mockStd = m::mock(\stdClass::class);
        $mockStd->id = 1;
    ...
    public function test_if_should_return_create()
    {
        $mockRepository = m::mock(AbstractRepository::class);
        $mockStd = m::mock(\stdClass::class);
        $mockStd->id = 1;
    ...
    public function test_if_should_return_update_sussess()
    {
        $mockRepository = m::mock(AbstractRepository::class);
        $mockStd = m::mock(\stdClass::class);
        $mockStd->id = 1;
     ...
     */
    public function test_if_should_return_update_fail()
    {
        $mockRepository = m::mock(AbstractRepository::class);
        ...
        $mockRepository->shouldReceive('update')
                ...
                ->andThrow($throw);
        $result = $mockRepository->update(['name' => 'stdClassName'], 0);
        $this->assertEquals(1, $result->id);
        $this->assertInstanceOf(\stdClass::class, $result);
    }

    public function test_if_should_return_delete_sussess()
    {
        $mockRepository = m::mock(AbstractRepository::class);
     ...
     * @expectedException \Illuminate\Database\Eloquent\ModelNotFoundException
     */
    public function test_if_should_return_delete_fail()
    {
        $mockRepository = m::mock(AbstractRepository::class);
        $throw = new ModelNotFoundException();
        $throw->setModel(\stdClass::class);
    ...
    public function test_if_should_return_find_without_columns_sussess()
    {
        $mockRepository = m::mock(AbstractRepository::class);
    ...
    public function test_if_should_return_find_with_columns_sussess()
    {
        $mockRepository = m::mock(AbstractRepository::class);
     ...
     * @expectedException \Illuminate\Database\Eloquent\ModelNotFoundException
     */
    public function test_if_should_return_find_fail()
    {
        $mockRepository = m::mock(AbstractRepository::class);
        $throw = new ModelNotFoundException();
        $throw->setModel(\stdClass::class);
    ...
    public function test_if_should_return_findBy_with_columns_sussess()
    {
        $mockRepository = m::mock(AbstractRepository::class);
    ...
    public function test_if_should_return_findBy_empty_sussess()
    {
        $mockRepository = m::mock(AbstractRepository::class);
